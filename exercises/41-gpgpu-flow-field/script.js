...
debugObject.clearColor = "#07091c"
renderer.setClearColor(debugObject.clearColor)

/**
 * Model
 */
const gltf = await gltfLoader.loadAsync("/models/Ship/ship.glb")
...
// Self-depend to create a loop for the variable
...
gui.add(particles.material.uniforms.uSize, "value").min(0).max(0.01).step(0.0001).name("uSize")
gui
